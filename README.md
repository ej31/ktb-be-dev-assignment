...
- log rotation 정책을 설정하고, 그 기준과 이유를 간단히 README.md에 남겨주세요.

### 옵션: 배포 후 녹화 및 README.md에 적용
- 코드 작성 완료 후 배포해주세요
- 어떤 방식으로 배포했는지 README.md에 상세히 작성해주세요.
- 배포하면서 신경쓴 점이 있다면 해당 부분도 함께 기술해주세요
- 영상 촬영 혹은 스크린샷을 제출하는 PR 내 README.md 에 남겨주세요
